...
bool KdTree::check_node(const std::vector<Object> &objs, Ray ray, int &no, int &nv, float &dis)
{
    dis=1e20;
...
bool KdTree::check(const std::vector<Object> &objs, Ray ray, int &no, int &nv, float &dis)
{
    dis = 1e20;
    float dis1=1e20;
